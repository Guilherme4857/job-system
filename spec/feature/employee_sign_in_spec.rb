...
feature 'Employer sign in' do
  scenario 'sign in' do
    employee = Employee.create!(email: 'joao@campuscode.com', password: '654321')
    ...
    expect(page).not_to have_link 'Entrar como candidato', href: new_job_seeker_session_path
    expect(page).not_to have_link 'Entrar como funcionário de empresa', href: new_employee_session_path       
end
