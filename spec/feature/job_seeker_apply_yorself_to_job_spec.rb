...
feature 'Job Seeker apply yorself to job' do
  scenario 'must be signed in' do
    ...
    Job.create!(company: company, title: 'Desenvolvedor Ruby', 
  ...
  scenario 'successfully' do
    ...
    job_seeker = JobSeeker.create!(
      ...
      password: '123456', social_name: 'Guilherme', 
      cpf: '22.333.444/5', 
    ...
    within('div#job') do
      ...
      expect(page).to have_link("Cancelar candidatura", 
                                href: unapply_to_job_path(job))      
      expect(page).not_to have_link("Candidatar-se a vaga", 
                                    href: apply_to_job_path(job))      
    end
  ...
  scenario 'and unaply' do
    ...
    within('div#job') do
      ...
      expect(page).to have_content("Data Limite: 23/04/2024")
      expect(page).to have_content("Faixa Salarial: R$2000 - R$2600")
      expect(page).to have_link("Candidatar-se a vaga", 
                                href: apply_to_job_path(job))      
      expect(page).not_to have_link("Cancelar candidatura", 
                                    href: unapply_to_job_path(job))      
    end
    expect(page).to have_link "Voltar", href: jobs_path 
  end
