  ...
  describe 'Job Seeker' do
    ...
    context '.all_applied_job_seekers' do
      it 'successfully' do
        ...
        first_job_seekers = JobSeeker.all_applied_job_seekers(first_company).count
        second_job_seekers = JobSeeker.all_applied_job_seekers(second_company).count

        expect(first_job_seekers).to eq 2
        expect(second_job_seekers).to eq 2
      end
    end
  end
end
