  ...
  describe 'Job Seeker' do
    ...
    context '.all_applied_job_seekers' do
      it 'successfully' do
        ...
        first_company_job_seekers = JobSeeker.all_applied_job_seekers(
          first_company
        ).count
        second_company_job_seekers = JobSeeker.all_applied_job_seekers(
          second_company
        ).count

        expect(first_company_job_seekers).to eq 1
        expect(second_company_job_seekers).to eq 1
      end
