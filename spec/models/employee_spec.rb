  ...
  describe 'Employee' do
    context '#company?' do
      ...
      it "and false if first company's employee register" do
        first_employee = Employee.create!(email: 'joao@campuscode.com.br', password: '123456')
        second_employee = Employee.create!(email:'gilberto@google.com', password: '123456')
        company = Company.create!(name: 'Google', cnpj: '55.444.333/0100-56', 
                                  site: 'google.com', company_history: 'Cresceu bastante')
        company_employee = CompanyEmployee.create!(company: company, employee: second_employee, hostname: '@google.com')
      ...
      it "true if not first company's employee registered" do
        ...
        first_employee = Employee.create!(email: 'joao@campuscode.com.br', password: '123456')
        second_employee =  Employee.create!(email: 'henrique@campuscode.com.br', password: '123456')
        ...
        company_employee = CompanyEmployee.create!(company: company, employee: first_employee, hostname: '@campuscode.com.br')
